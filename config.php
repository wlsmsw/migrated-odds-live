...
$settings = array(
            'alpha_url'          => "localhost:8080/mswdev/prod/",
            'staging_url'        => "mswsites.com/mswodds/",
            'live_url'           => "mswlive.com/mswodds/",
            'version'            => "1.0",
            ...
            'valid_request'      => array('sport','ky'), // set valid request here
...
class Config
{
   ...
   function all_sports_config()
   {
      ...
      try
      {
         ...
         {
            throw $err = new customException("error: mysql error <br />: " . $this->db_conn->error);
            return FALSE;
         }
      }
      catch (customException $e)
